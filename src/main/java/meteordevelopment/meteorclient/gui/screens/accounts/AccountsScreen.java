...
public class AccountsScreen extends WindowScreen {
    ...
    public void initWidgets() {
        ...
        addButton(l, "Refresh Token", () -> mc.setScreen(new AddRefreshTokenAccountScreen(theme, this)));
        addButton(l, "Session Token", () -> mc.setScreen(new AddSessionTokenAccountScreen(theme, this)));
        addButton(l, "API Controlled", () -> {
            if(MyVeryCoolAndCustomAPI.isSignedIn())
                mc.setScreen(new AddApiAccountScreen(theme, this));
            else
                mc.execute(() -> {
