        ...
        MeteorExecutor.execute(() -> accounts = NbtUtils.listFromTag(tag.getList("accounts", 10), tag1 -> {
            ...
            try {
                return switch (type) {
                    ...
                    case RefreshToken -> new RefreshTokenAccount(null).fromTag(t);
                    case SessionToken -> new SessionTokenAccount(null).fromTag(t);
                    case ApiAccount -> new ApiAccount(null).fromTag(t);
                };
